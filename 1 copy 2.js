...
async function to_doi(pos) {
    const templateImages = data.map(item => `C:\\Users\\huy\\Desktop\\Tools_farm\\z-output\\todoi\\${item.pos}.png`);
    const buffer = await runAdb(["-s", "127.0.0.1:16448", "exec-out", "screencap", "-p"]);
    const pngBuffer = await sharp(buffer)
        .extract({ left: 220, top: 80, width: 120, height: 380 })
        .toBuffer();
    // fs.writeFileSync("xxxxxxxxx.png", pngBuffer)
    ...
    for (const { x, y, mathImagePath } of matchedPoints) {
        if (mathImagePath == `C:\\Users\\huy\\Desktop\\Tools_farm\\z-output\\todoi\\${pos}.png`) {
            await tap("127.0.0.1:16448", x + 550 + 220, y + 80)
        }
    }
}
...
(async () => {
    ...
    // const templateImages = data.map(item => `${groupPaths[item.group]}\\${item.pos} ${item.group}.png`);
    ...
    //             const expectedPath = `${groupPaths[item.group]}\\${item.pos} ${item.group}.png`;
    //             return mathImagePath === expectedPath;
    //         });

    //         if (found?.name == "nong nhu" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "lam tai" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "nong tu" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "vo quang" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "phan my44" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "che linh4" && found?.group == "pnst") {

    //         }
    //         else if (found?.name == "hoang tram" && found?.group == "pnst") {

    //         }

    //         // hhnd
    //         else if (found?.name == "phan trang" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "duong hoang" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "tham diep" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "trinh dao" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "vo minh" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "phan long11" && found?.group == "hhnd") {

    //         }
    //         else if (found?.name == "bui sam5" && found?.group == "hhnd") {

    //         }

    //         // dts
    //         else if (found?.name == "na linh" && found?.group == "dts") {

    //         }
    //         else if (found?.name == "che hong22" && found?.group == "dts") {

    //         }
    //         else if (found?.name == "le dang" && found?.group == "dts") {

    //         }
    //         else if (found?.name == "phan hieu" && found?.group == "dts") {

    //         }
    //         else if (found?.name == "doan vinh" && found?.group == "dts") {

    //         }
    //         else if (found?.name == "lai tu23" && found?.group == "dts") {
