...
const MainBrowser = async (userProfileIndex, proxy, positionX, positionY) => {
    try {
        ...
        await cursorActionIframe.moveToSelector({ selector: "#app > div > view > view:nth-child(1)", iframe: client });
        await sleep(3000);
        ...
        const getTasks = async () => {
            let { result } = await sessionIframe.Runtime.evaluate({
                expression: `(()=>{
    let results = [];
    let items = document.querySelectorAll("#app > div > div.container > div > div.task-list > div > div > .task-item");
    for (let i=0;i<items.length;i++) {
        let check = items[i].querySelector('div > div > div.task-item-right > div.top-node > div.top-right-node > div:nth-child(1) > div > img').parentElement.querySelector('.task-time-down');
        if (!check) {
            results.push(i)
        }
    }
    return results;
        ...
        let a = document.querySelectorAll("#app > div > div.container > div > div.task-list > div > div > .task-item")[${tasks[0]}];
        ...
        a?.scrollIntoView({ behavior: "smooth", block: "start" });
            ...
            await cursorActionIframe.moveToSelector({
                selector: {
                    script: `(() => {
                    let rect = document.querySelectorAll("#app > div > div.container > div > div.task-list > div > div > .task-item")[${tasks[0]}].querySelector('.play-btn')?.getBoundingClientRect();
            ...
            await cursorActionIframe.moveToSelector({
                selector: {
                    script: `(() => {
                    let rect = document.querySelectorAll("#app > div > div.container > div > div.task-list > div > div > .task-item")[${tasks[0]}].querySelector('div > div > div.task-item-right > div.top-node > div.top-right-node > div:nth-child(1) > div > img')?.getBoundingClientRect();
                    if (rect && rect.width > 0) return JSON.parse(JSON.stringify(rect));
                    throw "error";
                })()`
                },
        ...
        await cursorActionIframe.moveToSelector({ selector: "#app > div > view > view:nth-child(3)", iframe: client });
        await sleep(2000);
        await cursorActionIframe.moveToSelector({ selector: "#app > div > div > div > div.task-list > div > div > div:nth-child(2) > div > div > div.task-item-right > div.top-node > div.top-right-node > div", iframe: true });
        await cursorActionIframe.moveToSelector({ selector: "#app > div > div > div > div.task-list > div > div > div:nth-child(2) > div > div > div.task-item-right > div.top-node > div.top-right-node > div", iframe: true });
        await cursorActionIframe.moveToSelector({ selector: "#app > div > div > div > div.task-list > div > div > div:nth-child(2) > div > div > div.task-item-right > div.top-node > div.top-right-node > div", iframe: true });
        await cursorActionIframe.moveToSelector({ selector: "#app > div > div > div > div.task-list > div > div > div:nth-child(2) > div > div > div.task-item-right > div.top-node > div.top-right-node > div", iframe: true });
        await sleep(2000);
