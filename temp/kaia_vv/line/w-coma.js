...
const MainBrowser = async ({ userProfileIndex, proxy, positionX, positionY, index }) => {
    try {
        ...
        setInterval(async () => {
            try {
                const { matchedPoints } = await findMatchingRegions({
                    client: tab,
                    templateImages: [
                        'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\okx_new.jpeg',
                        'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\x.jpeg',
                ...
                if (matchedPoints.length > 0) {
                    for (const { x, y, mathImagePath } of matchedPoints) {
                        if (mathImagePath == 'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\okx_new.jpeg') {
                        ...
                        //  else if (mathImagePath == 'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\x.jpeg') {
        ...
        //         client: tab,
        //         templateImages: [
        //             'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\1.jpeg',
        //         ],
        //         matchThreshold: 0.8,
        //         scale,
        //     });
        ...
        //     for (const { x, y, mathImagePath } of matchedPoints) {
        //         if (mathImagePath == 'C:\\Users\\huy\\Desktop\\Tools_Farm\\match-img\\coma\\1.jpeg') {
        //             ttt1 = true;
        //             await clickPoint(tab, 425, 150, 200);
        ...
        //             await sleep(1500);
        //             await clickPoint(tab, 65, 240, 200);
        //             await sleep(1500);
...
let scale = 0.5;
// scale = 1;
let linkRef = "https://game.tcomarena.com/"
