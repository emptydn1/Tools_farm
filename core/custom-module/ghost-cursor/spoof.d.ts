...
export interface GhostCursor {
    ...
    click: (selector?: string | ElementHandle, isMobile?: boolean, options?: ClickOptions) => Promise<void>;
...
export declare function path(start: Vector, end: BoundingBox | Vector, options?: number | PathOptions): Vector[] | TimedVector[];
export declare const createCursor: (page?: any, start?: Vector, performRandomMoves?: boolean, defaultOptions?: {
    /**
